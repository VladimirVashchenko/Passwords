...
//-------------------------
    ...
    public enum Notifier {
        ...
        public void setPopupLifetime(final Duration POPUP_LIFETIME) {
            popupLifetime = Duration.millis(clamp(1000, 20000, POPUP_LIFETIME.toMillis()));
        }
            ...
            for (int i = 0; i < popups.size(); i++) {
                switch (popupLocation) {
                    ...
                    case BOTTOM_CENTER://**
                        ...
                        break;
                    default:
                        //popups.get(i).setY(popups.get(i).getY() - height - spacingY); // TODO: 22.05.2016  просто пометка
                        popups.get(i).hide();//**
                }
            }
        }
        ...
        private void showPopup(final Notification NOTIFICATION) {
            ...
            //popups.add(POPUP); // TODO: 22.05.2016  просто пометка
            popups.setAll(POPUP);
            ...
            KeyFrame kfEnd = new KeyFrame(Duration.millis(150), fadeOutEnd);
            ...
            // Move popup to the left during fade out
